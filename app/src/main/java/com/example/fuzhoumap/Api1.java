...
//    	interfaceUtil("http://api.map.baidu.com/place/v2/detail?uid=382e9d69d8f6f53bfbdc85c7&output=json&scope=2&ak=QnK5CEbH3MgaYdHm7GpzPYrXv65okhEk", "", "GET");
        ...
        //行政区域检索
        String str=interfaceUtil("http://api.map.baidu.com/place/v2/search?query=商圈&tag=商圈&region=福州市&output=json&ak=QnK5CEbH3MgaYdHm7GpzPYrXv65okhEk&page_size=20&scope=2&filter=sort_name:overall_rating|sort_rule:0", "", "GET");
