...
//            out1 = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(f2, true)));;
            String str="";
...
//            out1.close();
    ...
    public static String deal(int page) {
...
//    	while(count<1000)
//    	{
        	String str=interfaceUtil("http://api.map.baidu.com/place/v2/search?query=餐饮&tag=餐饮&region=福州市&output=json&ak=QnK5CEbH3MgaYdHm7GpzPYrXv65okhEk&page_size=20&scope=2&filter=sort_name:overall_rating|sort_rule:0&page_num="+page, "", "GET");
//        	count++;
        	try{
        		Thread.sleep(1000);
        		}catch(Exception e){
